...
$softwareUpdateName = $header = $patch_tuesday.Year.ToString() + " " + `
    $patch_tuesday.Month.ToString() + " " + $month
...
#    -Schedule $dev_schedule -ApplyTo SoftwareUpdatesOnly -whatif
...
#    -Schedule $qa_schedule -ApplyTo SoftwareUpdatesOnly -whatif

# SCCM MW
#New-CMMaintenanceWindow -CollectionId $MW_SCCM_COLLECTION -Name ($header + 'MW SUM SCCM') `
#    -Schedule $sccm_schedule -ApplyTo SoftwareUpdatesOnly -whatif
